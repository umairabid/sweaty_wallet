...
RSpec.describe TransactionRules::PersistCondition do
  ...
  describe "#call" do
    ...
    let(:transaction_rule) { create(:transaction_rule, user: user, category: target_category) }
    ...
    context "when group condition is already added" do
      ...
      context "when params are correct" do
        let(:params) { { group_id: group_id, type: "tags", tags: "gumroad, transfer", join_by: "or" } }
